RSpec.describe Formsg::Sdk::SubmissionService do
  ...
  describe ".build_from" do
    ...
    context "Using dependency injection with crypto object" do
    ...
    context "without DI" do
      it "builds a submission" do
        ...
        expect(submission.responses.count).to eq(14)
        expect(submission.responses.first).to be_a(Formsg::Sdk::Models::Response)
  ...
  describe ".decrypt_for" do
    it "decrypts without needing to initialize Crypto object" do
      data = {
        encryptedContent: ciphertext,
        version: internal_test_version
      }
