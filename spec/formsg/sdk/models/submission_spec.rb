RSpec.describe Formsg::Sdk::Models::Submission do
  describe "#initialize" do
    it "builds a submission" do
      ...
      result = Formsg::Sdk::Models::Submission.new(data)

      expect(result.form_id).to eq("5fa0e7880ABCD")
      expect(result.submission_id).to eq("601fd2e720ebf3ABCD")
      expect(result.version).to eq(1)
      expect(result.created_at).to eq(DateTime.parse("2021-02-07T11:45:43.740Z"))
    end
  end
